...
B_evl_FreqData = pd.DataFrame(np.load('./B_FreqDataDic.npy',allow_pickle=True).item())
S_evl_FreqData = pd.DataFrame(np.load('./S_FreqDataDic.npy',allow_pickle=True).item())
H_evl_FreqData = pd.DataFrame(np.load('./H_FreqDataDic.npy',allow_pickle=True).item())
P_evl_FreqData = pd.DataFrame(np.load('./P_FreqDataDic.npy',allow_pickle=True).item())
