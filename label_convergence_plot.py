...
training_record = np.load("./<SuperMarioBrosEnv<SuperMarioBros-1-1-v0>>/experiment_final_2e7/record.npy", allow_pickle=True).item()
...
plt.title('Environment SuperMarioBros 1',fontsize=16)
leg1 = plt.legend(bbox_to_anchor=(1, 1), ncol=4)
plt.show()
