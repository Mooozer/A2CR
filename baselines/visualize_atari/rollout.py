...
prepro = lambda img: imresize(img[35:195].mean(2), (80,80)).astype(np.float32).reshape(1,80,80)/255. if img.shape != (3, 84, 84) \
                     else imresize(img.mean(0), (80,80)).astype(np.float32).reshape(1,80,80)/255. # SuperMarioBros
